...
export function Button({
  ...
  return (
    <button
      className={cn(
        "inline-flex items-center justify-center gap-2 rounded-control border font-medium transition-[color,background-color,border-color] duration-fast ease-out",
